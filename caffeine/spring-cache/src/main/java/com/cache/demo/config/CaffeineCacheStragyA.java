...
/**
 * @ClassName: CaffeineCacheSub
 * @Description: TODO
 * @Author: qudi
 * @Date: 2020/9/11 9:29
 * @Version: 1.0
 */
public class CaffeineCacheStragyA extends CaffeineCacheStragy {

    private static final String CACHE_NAME = "cacheA_name";
